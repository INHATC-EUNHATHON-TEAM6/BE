...
public interface AiDictionaryClient {
    ...
    Mono<AiPickResult> pickBestFromNiklCandidates(String surface, String context, List<DictEntry> cands);
    Mono<AiPickResult> pickBestFromNiklCandidatesV2(String surface, String context, List<DictEntry> cands); // (신규)
